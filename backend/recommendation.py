...
CONTENT_CATALOG = [
    ...
    {"title": "Severance", "platform": Platform.HBO_MAX, "category": Category.SCIFI, "actors": ["Adam Scott", "Zach Cherry", "Britt Lower"], "director": "Dan Erickson", "year": 2022, "description": "Employees undergo a procedure to separate work and personal memories.", "similar_to": ["Westworld", "Black Mirror"]},
    ...
    {"title": "Slow Horses", "platform": Platform.HBO_MAX, "category": Category.THRILLER, "actors": ["Gary Oldman", "Jack Lowden", "Olivia Colman"], "director": "Adam Gerahty", "year": 2022, "description": "British intelligence agents stuck in a dead-end job.", "similar_to": ["The Night Manager", "Killing Eve"]},
    ...
    {"title": "For All Mankind", "platform": Platform.HBO_MAX, "category": Category.SCIFI, "actors": ["Joel Kinnaman", "Michael Dorman", "Sarah Jones"], "director": "Ronald D. Moore", "year": 2019, "description": "NASA races the Soviets in an alternate space history.", "similar_to": ["The First", "From the Earth to the Moon"]},
    {"title": " Disclaimer", "platform": Platform.HBO_MAX, "category": Category.THRILLER, "actors": ["Cate Blanchett", "Kevin Kline", "Sasha Wilder"], "director": "Alfonso Cuarón", "year": 2024, "description": "A journalist's career is destroyed by a mysterious video.", "similar_to": ["The Night Of", "Gone Girl"]},
